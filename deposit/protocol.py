...
class RepositoryProtocol(object, metaclass = RepositoryProtocolMeta):
    ...
    def get_form(self):
        ...
        return self.form_class(abstract_required=abstract_required, ddcs=ddcs, licenses=licenses, initial=initial)
    ...
    def get_bound_form(self, data):
        ...
        return self.form_class(abstract_required=abstract_required, ddcs=ddcs, licenses=licenses, data=data)
